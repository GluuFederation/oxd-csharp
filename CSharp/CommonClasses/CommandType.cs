namespace CSharp.CommonClasses
{
    ...
    public static class CommandType
    {
        ...
        public static string update_site_registration = "update_site";
        ...
        public static string remove_site = "remove_site";
        public static string introspect_access_token = "introspect_access_token";
        ...
        public static string introspect_rpt = "introspect_rpt";
    ...
    public static class RestCommandType
    {
        ...
        public static string remove_site = "remove-site";
        public static string introspect_access_token = "introspect-access-token";
        ...
        public static string introspect_rpt = "introspect-rpt";
